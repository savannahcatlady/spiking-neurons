...
void initialize() {
    int i=0, j=0, k=0, jj=0, dd=0, exists=0, r=0;
...
void	polychronous(int nnum) {
    int	i=0, j=0, t=0, tf=0, p=0, k=0;
    int npre[W];
    int d=0, exc=0, NL=0, NL_max=0;
    int	t_fire=0, t_last=0, timing=0;
    int	N_fired=0, Dmax=0, already=0;
    int	first=0, last=0;
    int	used[W]={0}, discard=0;
    N_my_pre = 0;
